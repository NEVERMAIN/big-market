/*
 ...
 Source Server         : 139.9.212.188
 Source Server Type    : MySQL
 Source Server Version : 80032
 Source Host           : 139.9.212.188:13306
...
CREATE TABLE `user_credit_order_003`  (
  ...
  UNIQUE INDEX `uq_out_business_no`(`out_business_no` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户积分订单记录' ROW_FORMAT = Dynamic;
